...
const InstagramFeed = ({ username }) => {
    ...
    try {
      ...
      script.onload = () => {
        if (window.instgrm) {
          ...
          setError("Instagram embed script loaded but instgrm object not available.");
        }
      };
      script.onerror = () => {
      ...
      console.error('Error loading Instagram embed script:', err);
      setError('Could not load Instagram embeds. Please try again later.');
    }
  };
  
  useEffect(() => {
    // Load the Instagram embeds after a short delay to ensure the component is mounted
  ...
  return (
    <FeedContainer>
      ...
      {/* First Instagram Embedded Reel */}
      <EmbedContainer>
        <blockquote 
          className="instagram-media" 
          data-instgrm-captioned 
          data-instgrm-permalink="https://www.instagram.com/reel/DGvuJSVyYmA/?utm_source=ig_embed&amp;utm_campaign=loading" 
        ...
        >
          <div style={{ padding: '16px' }}>
            <a 
              href="https://www.instagram.com/reel/DGvuJSVyYmA/?utm_source=ig_embed&amp;utm_campaign=loading" 
              style={{
                background: '#FFFFFF',
                lineHeight: '0',
                padding: '0',
            ...
            <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              <a 
                ...
                rel="noreferrer"
              >
                A post shared by Tea Country Holidays (@tea_country_holidays)
              </a>
            </p>
          </div>
        </blockquote>
      ...
      {/* Second Instagram Embedded Reel */}
      <EmbedContainer>
        <blockquote 
          className="instagram-media" 
          data-instgrm-captioned 
          data-instgrm-permalink="https://www.instagram.com/reel/DFZg8Dty2iW/?utm_source=ig_embed&amp;utm_campaign=loading" 
          data-instgrm-version="14" 
          style={{
            background: '#FFF',
            border: '0',
        ...
        >
          <div style={{ padding: '16px' }}>
            <a 
              href="https://www.instagram.com/reel/DFZg8Dty2iW/?utm_source=ig_embed&amp;utm_campaign=loading" 
              style={{
                background: '#FFFFFF',
                lineHeight: '0',
                padding: '0',
      ...
      {/* Third Instagram Embedded Reel */}
      <EmbedContainer>
        <blockquote 
          className="instagram-media" 
          data-instgrm-captioned 
          data-instgrm-permalink="https://www.instagram.com/reel/DHQHWHhRxB3/?utm_source=ig_embed&amp;utm_campaign=loading" 
          data-instgrm-version="14" 
          style={{
            background: '#FFF',
            border: '0',
        ...
        >
          <div style={{ padding: '16px' }}>
            <a 
              href="https://www.instagram.com/reel/DHQHWHhRxB3/?utm_source=ig_embed&amp;utm_campaign=loading" 
              style={{
                background: '#FFFFFF',
                lineHeight: '0',
                padding: '0',
      ...
      {/* Fourth Instagram Embedded Reel */}
      <EmbedContainer>
        <blockquote 
          className="instagram-media" 
          data-instgrm-captioned 
          data-instgrm-permalink="https://www.instagram.com/reel/DHk9lSWygjZ/?utm_source=ig_embed&amp;utm_campaign=loading" 
          data-instgrm-version="14" 
          style={{
            background: '#FFF',
            border: '0',
        ...
        >
          <div style={{ padding: '16px' }}>
            <a 
              href="https://www.instagram.com/reel/DHk9lSWygjZ/?utm_source=ig_embed&amp;utm_campaign=loading" 
              style={{
                background: '#FFFFFF',
                lineHeight: '0',
                padding: '0',
      ...
      {/* You can add more embedded posts here */}
      <EmbedContainer>
        <blockquote 
          className="instagram-media" 
          data-instgrm-captioned 
          data-instgrm-permalink="https://www.instagram.com/tea_country_holidays/" 
          data-instgrm-version="14"
          style={{
            background: '#FFF',
            border: '0',
        ...
        >
          <div style={{ padding: '16px' }}>
            <a
              href="https://www.instagram.com/tea_country_holidays/"
              style={{
                background: '#FFFFFF',
                lineHeight: '0',
                padding: '0',
            ...
            <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              <a
                ...
                rel="noreferrer"
              >
                View more posts from Tea Country Holidays
              </a>
            </p>
          </div>
        </blockquote>
